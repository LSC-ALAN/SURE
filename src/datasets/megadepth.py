...
from src.utils.dataset import read_megadepth_gray, read_megadepth_depth,read_megadepth_color

def fix_path_from_d2net(path):
    if not path:
        return None

    path = path.replace('Undistorted_SfM/', 'phoenix/S6/zl548/MegaDepth_v1/')
